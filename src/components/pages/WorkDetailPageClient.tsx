    ...
    const timer = window.setInterval(async () => {
      ...
      try {
        ...
        if (payload.work) {
          ...
          if (nextStatus === "succeeded" && !nextHasResult) completedRecoveryAttemptsRef.current += 1;
          if (nextStatus === "failed" || (nextStatus === "succeeded" && nextHasResult)) window.clearInterval(timer);
        }
      } catch {
