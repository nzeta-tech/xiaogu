...
export function buildXiaohongshuCheckPrompt(
  ...
  return [
    ...
    "9. 必须同时检查标题、封面文案、正文、话题、评论区引导（如有）：标题/封面与正文是否不一致或诱导点击；是否出现电话、微信、二维码、主页/私信等站外导流或规避审核的谐音、表情、变体字；是否贬损、失实对比或在竞品内容下截流；是否涉及未经资质支撑的金融、医疗、法律等强资质服务营销；是否使用平台名义背书、虚假按钮或不实身份；是否侵犯隐私、肖像、版权或泄露客户信息。",
    "10. 原因必须具体指出风险来源，例如绝对化承诺、诱导交易、标题党、站外导流、变体规避、竞品抹黑、资质风险、具体险种敏感表达、收益暗示、资产隔离避债表述、医疗或财税误导等。",
    "11. 整体语气要像专业内容审核顾问，不要写成聊天回复、提纲、教程或营销文案。",
    "12. 不要输出 Markdown 表格，不要使用代码块，不要额外添加花哨结构。",
    "待检查的小红书内容：",
    content,
  ].filter(Boolean).join("\n\n");
}
