...
export const creationApps: CreationApp[] = [
  {
    ...
    fields: [
      ...
      { id: "length_mode", label: "笔记长度", type: "radio", required: true, options: [{ label: "常规 · 约 500 字", value: "standard" }, { label: "长文 · 1000 字以内", value: "long" }] },
    ],
  },
  {
    id: "wechat-studio",
    ...
    fields: [
      {
        ...
        required: true,
        options: [
          { label: "朋友圈知识科普", value: "illustration", previewUrl: "/examples/image-card-styles/illustration.webp?v=20260820" },
          { label: "客户面谈讲解", value: "whiteboard", previewUrl: "/examples/image-card-styles/whiteboard.webp?v=20260820" },
          { label: "专业方案展示", value: "business", previewUrl: "/examples/image-card-styles/business.webp?v=20260820" },
          { label: "一眼看懂的知识点", value: "flat-knowledge", previewUrl: "/examples/image-card-styles/flat-knowledge.webp?v=20260820" },
          { label: "复杂问题图解", value: "science-sketch", previewUrl: "/examples/image-card-styles/science-sketch.webp?v=20260820" },
          { label: "高端客户沟通", value: "zen", previewUrl: "/examples/image-card-styles/zen.webp" },
          { label: "条款重点拆解", value: "line-illustration", previewUrl: "/examples/image-card-styles/line-illustration.webp?v=20260820" },
          { label: "高净值客户服务", value: "luxury", previewUrl: "/examples/image-card-styles/luxury.webp?v=20260820" },
          { label: "公众号深度解读", value: "magazine", previewUrl: "/examples/image-card-styles/magazine.webp?v=20260820" },
          { label: "热点观点表达", value: "graffiti", previewUrl: "/examples/image-card-styles/graffiti.webp?v=20260820" },
          { label: "线下分享课件", value: "event-stage", previewUrl: "/examples/image-card-styles/event-stage.webp?v=20260820" },
          { label: "顾问手写说明", value: "handwritten-notes", previewUrl: "/examples/image-card-styles/handwritten-notes.webp?v=20260820" },
          { label: "亲子家庭科普", value: "clay", previewUrl: "/examples/image-card-styles/clay.webp?v=20260820" },
          { label: "日常轻量科普", value: "minimal-drawing", previewUrl: "/examples/image-card-styles/minimal-drawing.webp?v=20260820" },
          { label: "课堂知识讲解", value: "blackboard", previewUrl: "/examples/image-card-styles/blackboard.webp?v=20260820" },
          { label: "品牌内容沉淀", value: "morandi", previewUrl: "/examples/image-card-styles/morandi.webp?v=20260820" },
          { label: "专业数据解读", value: "dark-pro", previewUrl: "/examples/image-card-styles/dark-pro.webp" },
          { label: "清爽社媒科普", value: "fresh-card", previewUrl: "/examples/image-card-styles/fresh-card.webp?v=20260820" },
          { label: "每日客户触达", value: "daily-sign", previewUrl: "/examples/image-card-styles/daily-sign.webp" },
          { label: "学习笔记整理", value: "study", previewUrl: "/examples/image-card-styles/study.webp?v=20260820" },
          { label: "一句话观点发布", value: "large-sign", previewUrl: "/examples/image-card-styles/large-sign.webp?v=20260820" },
          { label: "黑白专业观点", value: "black-white", previewUrl: "/examples/image-card-styles/black-white.webp" },
          { label: "生活化经验分享", value: "scrapbook", previewUrl: "/examples/image-card-styles/scrapbook.webp?v=20260820" },
          { label: "重点结论强调", value: "white-orange-blue", previewUrl: "/examples/image-card-styles/white-orange-blue.webp?v=20260820" },
          { label: "行业简报解读", value: "daily", previewUrl: "/examples/image-card-styles/daily.webp?v=20260820" },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        options: [
          { label: "观点大字报", value: "video-bold-opinion", previewUrl: "/examples/video-cover-styles/bold-opinion.png" },
          { label: "真人口播感", value: "video-talking-head", previewUrl: "/examples/video-cover-styles/talking-head.png" },
          { label: "新闻观察", value: "video-news-observation", previewUrl: "/examples/video-cover-styles/news-observation.png" },
          { label: "家庭情绪", value: "video-family-emotion", previewUrl: "/examples/video-cover-styles/family-emotion.png" },
          { label: "知识卡片", value: "video-knowledge-card", previewUrl: "/examples/video-cover-styles/knowledge-card.png" },
