  ...
  "data": [
    {
      ...
      "title": "示例标题",
      "platform": "douyin",
      "platform_adapter": "douyin_official",
...
`platform_adapter` identifies the approved adapter (`douyin_official`, `wechat_channels_official`, `tiktok_official`, or `approved_other`) and must match `platform`; a mismatch is filtered. This is an authorization declaration from the provider, not proof inferred from a URL.
