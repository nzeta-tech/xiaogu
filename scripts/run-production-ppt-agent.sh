...
export LOCAL_AGENT_VERSION=$(git -C "$repo_path" rev-parse --short=12 HEAD)
...
export PPT_TASK_TIMEOUT_MS=${PPT_TASK_TIMEOUT_MS:-240000}

exec "$node_bin" "$repo_path/scripts/local-agent.mjs"
