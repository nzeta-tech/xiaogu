...
export async function createExpressionMaterial(segment,dir,index,options={}){
  ...
  const relationLabels={compare:["对照 A","对照 B","对照 C","对照 D"],sequence:["步骤 1","步骤 2","步骤 3","步骤 4"],timeline:["节点 1","节点 2","节点 3","节点 4"],cause:["原因","结果","延伸","结论"],parts:["组成 1","组成 2","组成 3","组成 4"],keypoints:["要点 1","要点 2","要点 3","要点 4"]};
