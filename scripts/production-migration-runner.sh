...
rsync -a -e "ssh -i $ssh_key" "$repo_path/scripts/regression-workbuddy-traffic-persistence.mjs" "$primary:$remote_stage/regression-workbuddy-traffic-persistence.mjs"
